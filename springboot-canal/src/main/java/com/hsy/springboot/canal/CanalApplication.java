...
import com.askingdata.y.cache.redis.spring.string.impl.StringValueOperationsBase;
...
//        SpringApplication.run(CanalApplication.class,args) ;
    ...
    private static StringValueOperationsBase stringValueOperationsBase;

    @Autowired
    public void setStringValueOperationsBase(StringValueOperationsBase stringValueOperationsBase){
        CanalApplication.stringValueOperationsBase = stringValueOperationsBase;
    }
